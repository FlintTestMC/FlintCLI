...
By default, the visualizer URL is built using `http://localhost:5173`. You can customize this by setting the `FLINT_VIZ_URL` environment variable:

```bash
FLINT_VIZ_URL="http://your-viz-host:5173" flintmc example_tests/ -s localhost:25565
```
